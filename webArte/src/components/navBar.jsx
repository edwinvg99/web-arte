    ...
    <header className="text-gray-300 body-font border-b-2 border-blue-400 mb-5 ">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center bg-blue-4--">
        ...
        <div className=" w-full flex max-sm:flex-col ">
          ...
          <div className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400 md-flex-col	flex flex-wrap items-center text-base justify-center max-md:ml-5 max-sm:ml-0 ">
          ...
          <div className=" md:ml-4 md:py-1 md:pl-4 00	flex flex-wrap items-center text-base justify-end max-sm:justify-center">
