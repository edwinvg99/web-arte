        ...
        <div className="flex flex-wrap -m-4">
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                Gustave Courbet fue el principal representante del realismo en
                Francia y por lo tanto influyó en el desarrollo de los
                siguientes estilos artísticos.
              </p>
            </div>
          </div>
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
              <img
                className="h-40 rounded w-full object-cover object-center mb-6"
                src="https://www.reprodart.com/images/template-pics/Biografien/self_portrait_millet.jpg"
                alt="content"
              />
              <h3 className="tracking-widest text-indigo-400 text-xs font-medium title-font">
                1814 † 1875
              ...
              <p className="leading-relaxed text-base">
                illet fue nombrado Caballero de la Legión de Honor. A fines de
                la década de 1960, Jean-François Millet recibió el
                reconocimiento correcto por su trabajo, seguido por el éxito
                financiero. Sus obras han sido expuestas en exposiciones
                internacionales.
              </p>
            </div>
          </div>
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
              <img
                className="h-40 rounded w-full object-cover object-center mb-6"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGHwshlWEEliibN9jB6NrTszRhzHe3jpbLsqmW5xb62IGyuwyY9JQZX1DA0bcXl5RhW6A&usqp=CAU"
                alt="content"
              />
              <h3 className="tracking-widest text-indigo-400 text-xs font-medium title-font">
                1815 † 1905
              ...
              <p className="leading-relaxed text-base">
                Con su técnica pictórica y su estilo personal, Menzel fue un
                artista adelantado a su tiempo. Su expresión pictórica libre y
                sus pinceladas abiertas no encontraron el favor de un público
                más amplio hasta más tarde.
              </p>
            </div>
          </div>
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
              <img
                className="h-40 rounded w-full object-cover object-center mb-6"
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Ivan_Shishkin_restoration.jpg/220px-Ivan_Shishkin_restoration.jpg"
                alt="content"
              />
              <h3 className="tracking-widest text-indigo-400 text-xs font-medium title-font">
                1832 † 1898
              ...
              <p className="leading-relaxed text-base">
                Iván Ivánovich Shishkin fue un pintor paisajista, grabador y
